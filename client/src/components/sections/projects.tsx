  ...
  return (
    <section id="projects" className="py-16 bg-white dark:bg-gray-900" ref={sectionRef}>
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold mb-4 text-center animated-slide-up">
          My <span className="text-gradient">Projects</span>
        </h2>
        <p className="text-center text-gray-600 dark:text-gray-300 mb-12 max-w-2xl mx-auto animated-slide-up">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <div
              key={project.id}
              className={`project-card bg-gray-50 dark:bg-gray-800 rounded-xl overflow-hidden shadow-md animated-slide-up transition-all duration-500 ${index >= 6 && !showAll ? 'hidden' : ''}`}
